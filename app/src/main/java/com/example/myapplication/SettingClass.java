...
public class SettingClass {
    ...
    public SettingClass(String Fav_Name, int ROUNDS, String TRAINING_TIME, String BREAK_TIME, int DELAY_TIME, boolean SOUND_ON, int SOUND_VOLUME, boolean VIBRATION_ON, boolean PRELIMINARY_SOUND_ON, int PRELIMINARY_TIME, boolean PROXIMITY_ON, boolean SHAKE_ON) {
        this.Fav_Namme = Fav_Name;
        this.ROUNDS = ROUNDS;
    ...
    public SettingClass(int ROUNDS, String TRAINING_TIME, String BREAK_TIME, int DELAY_TIME, boolean SOUND_ON, int SOUND_VOLUME, boolean VIBRATION_ON, boolean PRELIMINARY_SOUND_ON, int PRELIMINARY_TIME, boolean PROXIMITY_ON, boolean SHAKE_ON) {
        this.ROUNDS = ROUNDS;
        this.TRAINING_TIME = TRAINING_TIME;
        this.BREAK_TIME = BREAK_TIME;
        this.DELAY_TIME = DELAY_TIME;
